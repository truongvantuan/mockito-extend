...
import org.mockito.internal.configuration.excelprocessor.ExcelMapperAnnotationProcessor;
...
public class IndependentAnnotationEngine implements AnnotationEngine {
    ...
    public IndependentAnnotationEngine() {
        ...
        registerAnnotationProcessor(ExcelMapper.class, new ExcelMapperAnnotationProcessor());
    }
